...
### Исправлено
- Исправлена SSRF-уязвимость: серверный API-ключ больше не передаётся на пользовательские LLM URL
- Санитизация ошибок LLM API: ключ не утекает в сообщениях об ошибках
