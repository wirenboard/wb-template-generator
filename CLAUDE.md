...
`jinja_exporter.py` обнаруживает повторяющиеся каналы с числом в имени (начало, середина, конец) и арифметической прогрессией адресов → сворачивает в `{% for %}`. Минимум 2 канала для паттерна.
